...
CASOS = [
    ...
    Caso("01-09 R15: reponer el recibo con el freno puesto", INDEX,
         "function reponerRecibo() {\n  if (libroPendiente) return;",
         "function reponerRecibo() {",
         1, "01-09 AC-1 y ese guardado no repone el recibo con el freno puesto"),
